...
motor_shaft = 54.5;	// NEMA17 motor shaft exact diameter = 5
...
pulley_b_ht = 11;		// pulley base height, standard = 8. Set to same as idler_ht if you want an idler but no pulley.
